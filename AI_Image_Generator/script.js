...
// const OPENAI_API_KEY = "sk-qI0e7piu8j1l9SQT3BlbkFJankTktGdIS7c3fVOjarP"; // Your OpenAI API key here
...
const generateBtn = generateForm.querySelector(".generate-btn");
const imageGallery = document.querySelector(".image-gallery");
const OPENAI_API_KEY = "nfH0e7piu8j1l9SQT3BlbkFJankTktGdIS7c3fVOjarP"; 
let isImageGenerating=false;
const updateImageCard=(imgDataArray)=>
{
  imgDataArray.forEach((imgObject,index)=>
...
generateForm.addEventListener("submit",handleFormSubmision);
